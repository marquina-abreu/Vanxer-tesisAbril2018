...
<center><section class="paginacion">
	<ul>
	   ...
	   <?php else: ?>
	   	<li ><a href="index_transportista.php?p=<?php echo pagina_actual_trans() - 1; ?>#mostrar_noti">❮</a></li>
	   <?php endif; ?>
	 ...
	 <?php for($i=1; $i <= $numero_paginas; $i++): ?>
	   ...
	   <?php else: ?>
		<li><a href="index_transportista.php?p=<?php echo $i;?>#mostrar_noti"><?php echo $i; ?></a></li>
	   <?php endif; ?>
