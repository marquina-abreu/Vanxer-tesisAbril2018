		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id=navegacion-trans>
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="solictud_clientes.php">Mantenimiento <span class="glyphicon glyphicon-cog "></span></a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
						       <li id="solvente"><a class="btn btn-success">Conectado <span class="has-success glyphicon glyphicon-ok"></span></a></li>
						       <li class="divider"></li>
