		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id=navegacion-trans>
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="index.php">Inicio <span class="glyphicon glyphicon-home "></span></a></li>
					...
					<li class="dropdown"><a href="solicitudes_trans.php">Solicitudes <span class="glyphicon glyphicon-envelope "></span></a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
						       ...
						       <li class="divider"></li>
						       <a href="#" class="btn btn-primary">Perfil</a><br>
						       <a href="../logout.php" id="cerrar" class="btn btn-danger">Cerrar Sesion <span class="glyphicon glyphicon-log-out"></span></a>
					       </ul>
						</li>
						</ul>
