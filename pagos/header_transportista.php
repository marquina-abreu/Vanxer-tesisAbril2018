...
// si no fue iniciada que vaya a mamar
 ...
 $id_transportista= $resul_id_t["0"]; // Acomodo el Arreglo.. y listo ya tengo el ID del transportista traido soy el webo..

 //Datos del cliente
 $consul= $conexion->prepare("SELECT nombre_trans, foto_trans, apellido_trans, telefono_trans, capacidad, usuarios.clave FROM transportistas INNER JOIN usuarios on usuarios.id_usuario=transportistas.id_usuario_trans WHERE usuarios.usuario=:usu_t");
			...
			<div class="collapse navbar-collapse" id=navegacion-trans>
				<ul class="nav navbar-nav">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="../../Clientes_tr/">Clientes</a></li>
					</ul></li>
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="divider"></li>
						<li><a href="../realizados/">Pagos realizados</a></li>
						<li><a href="../pendientes/">Pagos Pendientes</a></li>
					</ul>
					</li>
