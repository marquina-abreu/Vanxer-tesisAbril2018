...
<div class="container">
      <div class="row">
      <div class="col-lg-7">
          <h3><?php echo $noticia["titulo_trans"]; ?></h3>
      ...
      <div class="row">
       <div class="col-lg-8">
         ...
         $res=$res['imagen_cli'];
          ...
          <?php if($res!=false){ ?>
          <div class="comment-avatar"><img src="Clientes/foto_perfil/<?php echo $res; ?>"></div>
          <?php }else{?>
         ...
         <a href='eliminar_comentario_trans.php?idcom=<?php echo $comentario["id_coment"] ?>&idn=<?php echo $id_noticia?>' class="btn btn-default pull-right"><span  class="glyphicon glyphicon-trash"></span></a>
...
<div class="row">
  <div class="col-lg-8">
    <input type="hidden" value="<?php echo $usuario_trans;?>" id="usua" name="usua">
