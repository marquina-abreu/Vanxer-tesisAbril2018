	...
	echo '<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">';
		echo '<div class="container">';
			echo '<div class="navbar-header">';
				...
				echo '<a href="../" class="navbar-brand"><img src="../../imagenes/Logo_vanxer2_blanco.png" class="img-responsive" style="width:150px; height:30px;"></a>';
			echo '</div>';
			...
			echo '<div class="collapse navbar-collapse" id=navegacion-trans>';
				echo '<ul class="nav navbar-nav">';
					...
					echo '<li class="dropdown"><a >Gestion de Pagos <span class="glyphicon glyphicon-briefcase  "></span></a></li>';
